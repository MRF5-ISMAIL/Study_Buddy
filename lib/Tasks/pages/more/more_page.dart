...
import 'package:flutter_application_chat/Tasks/pages/more/badges/focus_badges_page.dart';
import 'package:flutter_application_chat/Tasks/pages/more/badges/habit_badges_page.dart';
import 'package:flutter_application_chat/Tasks/pages/more/details/community_page.dart';
import 'package:flutter_application_chat/Tasks/pages/more/details/contribution_page.dart';
import 'package:flutter_application_chat/Tasks/pages/more/details/support_page.dart';
import 'package:flutter_application_chat/Tasks/pages/more/details/tutorial_selector.dart';
              ...
              children: [
                Expanded(
                  child: _buildActionTile(
                    context,
                    'Focus',
                    'lib/Tasks/assets/images/badges/focus_badge.png',
                    () => Navigator.push(
                      context,
                      CupertinoPageRoute(
                ...
                Expanded(
                  child: _buildActionTile(
                    context,
                    'Habits',
                    'lib/Tasks/assets/images/badges/habit_badge.png',
                    () => Navigator.push(
                      context,
                      CupertinoPageRoute(
