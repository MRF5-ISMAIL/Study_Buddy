...
class FocusTutorial {
  static List<TutorialPage> pages = [
    TutorialPage(
      ...
      imageAsset: 'lib/Tasks/assets/tutorials/focus/set_time.png',
    ),
    TutorialPage(
      instruction: 'Tap play to start timer',
      imageAsset: 'lib/Tasks/assets/tutorials/focus/start_timer.png',
    ),
    TutorialPage(
      instruction: 'Listen to relaxing sounds',
      imageAsset: 'lib/Tasks/assets/tutorials/focus/relaxing_sounds.png',
    ),
  ];
